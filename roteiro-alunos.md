...
Quando tiver erro, envie:

1. print da tela inteira do Unity;
2. texto exato do erro no Console;
3. o que voce estava tentando fazer;
4. o que ja tentou;
5. versao do Unity usada;
6. se o erro acontece no Editor ou no Android.

Pedido ruim:

```text
Professor, nao funciona.
```

Pedido bom:

```text
Professor, ao clicar em Build aparece o erro "SDK not found".
Ja conferi se o modulo Android Build Support esta instalado.
Estou usando Unity LTS no Windows.
Segue print do Build Settings e do Console.
```
